...
public class AppManager : MonoBehaviour
{
    ...
    [SerializeField] private AppStateTitle stateTitle;
    [SerializeField] private AppStateMenu stateMenu;
    [SerializeField] private AppStateMatchmaking stateMatchmaking;
    [SerializeField] private AppStateLobby stateLobby;
    ...
    [Serializable]
    public class AppStateTitle : AppState
    {
        [Header("References")]
        ...
        [SerializeField] private float neutralFireBrightness = 0.01f;
        [SerializeField] private float hoveredFireBrightness = 0.09f;
        [SerializeField] private float hoveredBookOutlineAmount = 1.0f;
        [SerializeField] private float hoveredBookGlowAmount = 0.7f;
        [SerializeField] private float openingBookGlowAmount = 1.5f;
        [SerializeField] private float openingFireBrightness = 0.13f;
        ...
        {
            // Initialize book state and force
            app.cameraController.placeLerper.SetPlace(camPlace, true);
        ...
        private void ResetValues()
        {
            ...
            app.cameraController.placeLerper.positionlerpSpeed = camLerpSpeed;
    ...
    {
        [Header("Config")]
        [SerializeField] private string camPlace;
        [SerializeField] private string bookPlace;
        [SerializeField] private float camLerpSpeed = 0.8f;
        [SerializeField] private float bookOpenLerpSpeed = 0.8f;
        [SerializeField] private float fireBrightness;
        [SerializeField] private float bookGlowAmount;
        ...
        public override void Set()
        {
            ...
            // Reset all component values to base level
            app.book.outlineAmount = 0.0f;
            app.book.glowAmount = bookGlowAmount;
            app.book.toOpen = true;
            app.book.openLerpSpeed = bookOpenLerpSpeed;
            app.fire.brightness = fireBrightness;
        }

        public override void Unset()
        {
            // Reset book back to closed just incase
            app.book.toOpen = false;
        }
        ...
        public override void Update()
        {
            if (Input.GetMouseButtonDown(0)) app.GotoTitle();
        }
    }

    [Serializable]
    public class AppStateMatchmaking : AppState
    {

    }

    [Serializable]
    public class AppStateLobby : AppState
    {
    ...
    //[Serializable]
    //public class AppStateMenu_Old : AppState
    //{
    //    [Header("References")]
    ...
    //[Serializable]
    //public class AppStateSettings_Old : AppState
    //{
    //    [Header("References")]
    ...
    //[Serializable]
    //public class AppStateMatchmaker_Old : AppState
    //{
    //    [Header("Config")]
    //    [SerializeField] private Vector3 bookHoverPosOffset = new Vector3(0.0f, 2f, 0.0f);
    //    [SerializeField] private Quaternion bookHoverRotOffset = Quaternion.Euler(-10f, 0.0f, 0.0f);
    ...
    //    [SerializeField] private string camPlaceWait = "Default";
    //    [SerializeField] private string bookPlaceWait = "Tabletop Central";
    //    [SerializeField] private string camPlaceLoading = "Overview";
    ...
    //    {
    //        // Initialize book state
    //        app.cameraController.placeLerper.SetPlace(camPlaceWait);
    ...
    //        app.cameraController.placeLerper.SetPlace(camPlaceWait, true);
    //        app.fire.SetValues();
    //    }
    ...
    //            app.cameraController.placeLerper.SetPlace(camPlaceLoading);
    //            if (app.book.placeLerper.inPosition && matchmakingStatus == 1) StartMatchmaking();
    //            if (matchmakingStatus >= 1) app.book.placeLerper.SetOffsetRotation(Quaternion.AngleAxis(0.2f * spinTime * (360), Vector3.right));
    ...
    //        {
    //            if (!app.multiplayerManager.isConnected && !app.multiplayerManager.isConnecting) GotoPrev();
    ...
    //    private void GotoPrev() => app.GotoMenu();
    ...
    //[Serializable]
    //public class AppStateClassSelect_Old : AppState
    //{
    //    [Header("References")]
    ...
    //[Serializable]
    //public class AppStateIngame_Old : AppState
    //{
    //    // Declare variables
    ...
    public void GotoFirstState() => GotoTitle();

    [ContextMenu("Goto Title")]
    private void GotoTitle() => SetAppState(stateTitle);
    [ContextMenu("Goto Menu")]
    private void GotoMenu() => SetAppState(stateMenu);
    [ContextMenu("Goto Lobby")]
    private void GotoLobby() => SetAppState(stateLobby);
    [ContextMenu("Goto Matchmaking")]
    private void GotoMatchmaking() => SetAppState(stateMatchmaking);
